...
*/
void step_curl_stride1(RPR f, component c, const RPR g1, const RPR g2,
...
void step_beta_stride1(RPR f, component c, const RPR g,
...
void step_update_EDHB_stride1(RPR f, component fc, const grid_volume &gv,
